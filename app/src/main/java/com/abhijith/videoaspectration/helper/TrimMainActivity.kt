...
import com.abhijith.videoaspectration.databinding.CropActivityMainBinding
...
class TrimMainActivity : AppCompatActivity(), VideoTrimmerView.OnSelectedRangeChangedListener {

    lateinit var binding:CropActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = CropActivityMainBinding.inflate(layoutInflater)
        ...
        when (requestCode) {
            REQ_PICK_VIDEO -> {
                if (resultCode == Activity.RESULT_OK) {
                    videoPath = FileUtil.from(this@TrimMainActivity,data!!.data).absolutePath
