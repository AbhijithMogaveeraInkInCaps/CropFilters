...
import com.abhijith.videoaspectration.databinding.TrimmerMainActivityBinding
...
class MainActivity : AppCompatActivity(), VideoTrimmerView.OnSelectedRangeChangedListener {
    lateinit var binding: TrimmerMainActivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = TrimmerMainActivityBinding.inflate(layoutInflater)
